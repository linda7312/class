...
public:
    ...
    void inputEmployeeDetails() {
        ...
        getline(cin, startDate);  // Get the start date as a string
    ...
    void displayEmployeeDetails() const {
       ...
       // Display Start Date
        cout << "| " << setw(12) << left << startDate; // Display the start date
        cout << " |" << endl;
    }
...
private:
    ...
    // Merge function to merge two sorted parts of the employee list
...
public:
    ...
    // Function to sort employees based on employeeId (called in displayEmployees)
    ...
    if (employees.empty()) {
        ...
        // Sort the employees by employeeId before displaying
        const_cast<EmployeeManager*>(this)->sortEmployeesById();
    ...
    void deleteEmployee() {
        ...
        for (auto it = employees.begin(); it != employees.end(); ++it) {
            if (it->getEmployeeId() == employeeId) {
                found = true;
                employees.erase(it);
                cout << "Employee with ID " << employeeId << " has been deleted.\n";
                break;
            }
        }
...
int main() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            manager.deleteEmployee(); // Delete employee
        } else if (choice == 5) {
